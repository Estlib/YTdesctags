...
GM = input("Gamemode: ")
WITHP = int(input("Do people appear in this?: 0 = no, number of people for yes: "))
persons = []
while len(persons) != WITHP:
    persons.append(input("name of person: "))
...
T20 = [Estlibnetwork[0]+SC+Estlibnetwork[1]+SC+Estlibnetwork[4]+SC+Estlibnetwork[2]+SC+Estlibnetwork[3]+SC,Estlibnetwork[0]+SC+Estlibnetwork[1]+SC+Estlibnetwork[4]+SC+Estlibnetwork[5]+SC+Estlibnetwork[6]+SC,Estlibnetwork[0]+SC+Estlibnetwork[1]+SC+Estlibnetwork[4]+SC+Estlibnetwork[7]+SC+Estlibnetwork[8]+SC,Estlibnetwork[0]+SC+Estlibnetwork[1]+SC+Estlibnetwork[4]+SC+Estlibnetwork[9]+SC+Estlibnetwork[10]+SC,]
...
if NP != "":
    ...
    COND2[2] = ""
    COND2[3] = ""
roguestring= T01[0]+T02[0]+T03[0]+T04map+T05[0]+T06[0]+T07[0]+T08[0]+T09[0]+T10cgp+IB[0]+SC+T11skn+T12mgp+T13[0]+T14+T15+T16[0]+T17+COND1[0]+COND2[0]+T20[0] #+++++++++++++
realmstring= T01[2]+T02[2]+T03[2]+T04map+T05[2]+T06[2]+T07[2]+T08[2]+T09[2]+T10cgp+IB[0]+SC+T11skn+T12mgp+T13[2]+T14+T15+T16[2]+T17+COND1[2]+COND2[2]+T20[2] #+++++++++++++
palastring= T01[1]+T02[1]+T03[1]+T04map+T05[1]+T06[1]+T07[1]+T08[1]+T09[1]+T10cgp+IB[0]+SC+T11skn+T12mgp+T13[1]+T14+T15+T16[1]+T17+COND1[1]+COND2[1]+T20[1] #+++++++++++++
tf2stringH= T01[3]+T02[3]+T03[3]+T04map+T05[3]+T06[3]+T07[3]+T08[3]+T09[3]+T10cgp+IB[3]+SC+T11skn+T12mgp+T13[3]+T14+T15+T16[3]+T17+COND1[3]+COND2[3]+T20[3] #+++++++++++++
def descriptiongenerator():
    print("==================================")
    if GT == "RC" and DESCstat == "c": #rogue company casual
        print("Rogue Company casual match info:")
        print("")
        ...
        print("")
        print("Rogue Company ranked match info:")
        print("")
        print(" - Rogue: "+CHR.capitalize())
        print(" - Map: "+LVL.capitalize())
        print(" - Patch: "+P.capitalize())
        ...
        print("")
        print("Rogue Company LTM match info:")
        print("")
        print(" - Rogue: "+CHR.capitalize())
        print(" - Map: "+LVL.capitalize())
        print(" - Patch: "+P.capitalize())
        ...
        print("Paladins casual match info:")
        print("")
        ...
        print("Paladins ranked match info:")
        print("")
        ...
        print("Error, no ranked description layout yet.")
        print("")
        print("Realm Royale ranked match info:")
        print("")
        print(" - Class: "+CHR.capitalize())
        print(" - Subclass: "+SubC.capitalize())
        print(" - Patch: "+P.capitalize())
