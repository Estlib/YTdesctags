...
DESCmake = input("Generate description? (casual match only) y/n")
while GT == None:
...
realmstring= T01[1]+T02[1]+T03[1]+T04map+T05[1]+T06[1]+T07[1]+T08[1]+T09[1]+T10cgp+IB[0]+SC+T11skn+T12mgp+T13[1]+T14+T15+T16[1]+T17+COND1[1]+COND2[1] #+++++++++++++
palastring= T01[2]+T02[2]+T03[2]+T04map+T05[2]+T06[2]+T07[2]+T08[2]+T09[2]+T10cgp+IB[0]+SC+T11skn+T12mgp+T13[2]+T14+T15+T16[2]+T17+COND1[2]+COND2[2] #+++++++++++++
